/* arrays */
// explicit
let names: string[] = ["mario", "luigi", "peach"]; //only strings can be inside the survey
let ages: number[] = [20, 10, 5]; //only numbrs
...
let user: { age: number; firstName: string; uID: number } = {
  age: 30,
  firstName: "egon",
  uID: 1,
};
